...
```bash
git clone https://github.com/nbusso/busso_pfinal.git
```
...
Para esta entrega accediendo a la url inicial de la aplicacion, podremos movernos por las diferentes secciones con un menú. (http://localhost:8080/)

## Database

Se tienen dos colecciones en la base de datos de Mongo DB, _products_, el cual cuenta con productos con los respectivos ids, título, código, descripción, status, stock, categoría y thumbnail; y _carts_, que almacena los carritos que los usuarios van haciendo. A medida que se ejecuten los métodos en la aplicación, ambas colecciones se leerán y se actualizarán según corresponda.
...
- **[Socket.io](https://socket.io/)**: Biblioteca para la comunicación en tiempo real entre el servidor y el cliente.
  - Versión: `^4.7.5`
- **[Mongo DB](https://mongodb.com/)**: Biblioteca para la comunicación en tiempo real entre el servidor y el cliente.
  - Versión: `^4.7.5`
